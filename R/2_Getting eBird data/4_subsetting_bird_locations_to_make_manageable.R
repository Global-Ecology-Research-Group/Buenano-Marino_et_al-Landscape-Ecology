# This script creates an intermediate list of files
# so that we can get the land cover data around each eBird hotspot
# on Google Earth Engine

# These are all intermediate data files that are not on GitHub because they are too large. 
# However the outputs of the data are located in the .RDS city level files
...
cities <- read_rds("Intermediate_data/locations_in_cities/locations_in_cities.RDS")
