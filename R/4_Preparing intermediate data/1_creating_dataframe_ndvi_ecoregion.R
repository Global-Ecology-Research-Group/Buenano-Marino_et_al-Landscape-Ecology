...
## WILL NOT RUN because ebird object is too large
## output file is in ecoregion_ebird folder
...
#NDVI data
ndvi_est <- read_csv("Intermediate_data/ecoregion_ebird/250m_buffer_NDVI_scaled.csv")
...
ecoregion <- read_sf("Intermediate_data/ecoregion_ebird/epa_level2_eco/NA_CEC_Eco_Level2.shp") %>%
...
# saveRDS(eco_ebird_ndvi, file = "Intermediate_data/ecoregion_ebird/ecoregion_ebird_ndvi.RDS")
